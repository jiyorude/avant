...
setup_fifteen = "ERR010: Avant was unable to boot as some or multiple required files could not be found (such as pak files, quake3.exe or mme files)."
setup_sixteen = "The settings file for Avant has been deleted. The algorithm will terminate in a few seconds. Please reboot Avant and rerun the initial setup."
setup_seventeen = "ERR011: Avant was unable to boot as there is something wrong with the settings file. It may have been moved, renamed, edited or deleted."
setup_eighteen = "Avant will terminate in a few seconds. Please reboot the algorithm and rerun the initial setup."

proj_one = "ERR012: Project name contains more than 50 characters. Please try again."
proj_two = "Create New Project"
proj_three = "Modify Project"
proj_four = "Delete Project"
proj_five = "View All Projects"
proj_six = "Return to Main Menu"
proj_seven = "Hit the RETURN key to return to the Project Manager."
